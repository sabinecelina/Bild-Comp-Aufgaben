...
def filter_keypoints(matches, keypoints1, keypoints2, limit=0.5):
    # Code based on Lowe, D.G. Distinctive Image Features from Scale-Invariant Keypoints. International Journal of 
    # Computer Vision 60, 91–110 (2004). https://doi.org/10.1023/B:VISI.0000029664.99615.94 
...
def stereo_disparity_map(image1, image2):
    ...
    points1, points2, good_matches, all_matches = match_keypoints(keypoints1, keypoints2, descriptors1, descriptors2,
                                                                  filter_limit=0.6)
...
def disparity_map(reference_image, image_list):
    ...
    final_disparity_map = cv.normalize(final_disparity_map, final_disparity_map, alpha=255, beta=0,
